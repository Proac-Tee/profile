        ...
        >
          <div className="relative mb-[1rem] h-[150px] w-[100%] overflow-hidden rounded-lg border-[1px] border-border md:mb-0 md:h-[120px] md:w-[200px]">
            <Image
              ...
              priority
              className="hover:scale-125 transition-all duration-300 ease-in-out overflow-hidden"
          ...
          <div className="flex flex-col justify-between flex-1">
            <div>
              ...
              <div className="text-white pt-[1rem] flex gap-[1rem]">
            ...
            {expandedIndex === index && (
              <div className="pt-[1rem]">
                ...
                <ul className="pt-[1rem] flex flex-wrap items-center gap-[2rem]">
                  {project.liveUrl && (
                    <li>
                      <a
