...
const ProjectListSkeleton = () => {
  return (
    <div>
      <section
        className={cn(
          " flex flex-col md:flex-row mb-[2rem] justify-start gap-[1rem] h-[100%] py-[1rem]  bg-secondaryBackgroundColor border-border rounded-[0.875rem] border-[2px] px-[1rem]  relative animate-pulse",
        )}
      >
        <div className="relative h-[100%] w-[100%] md:w-[200px]">
          <div className={cn("h-[120px] bg-zinc-800 rounded")}></div>
        </div>
