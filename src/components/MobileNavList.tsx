...
const MobileNavList: FC<MobileNavListProps> = ({
  isExpanded,
  toggleDropdown,
}) => {
  ...
  return (
    ...
    >
      <div
        className={cn(
          "flex justify-between h-[2.75rem] items-center gap-[2rem] text-white",
        )}
      >
        <p
          className={cn(
